...
warn "\nInitializing the $long_mult_version pipeline ...\n\n";
    ...
    foreach my $pipeline_url (@pipeline_urls) {
        my $hive_dba = init_pipeline('Bio::EnsEMBL::Hive::PipeConfig::'.$long_mult_version, $pipeline_url, [-hive_force_init => 1]);
        ...
        system( $ENV{'EHIVE_ROOT_DIR'}.'/scripts/db_cmd.pl', '-url', $hive_dba->dbc->url, '-sql', 'DROP DATABASE' );
    }
}
