...
{       # OLD style (local) accu URL:
    ...
    is_deeply( $url_hash->{'query_params'}, { 'object_type' => 'Accumulator', 'struct_name' => 'partial_product', 'signature_template' => '{digit}' },
...
{       # NEW style accu URL:
    my $url = '?struct_name=intermediate_result&signature_template={digit}';
    ...
    is_deeply( $url_hash->{'query_params'}, { 'object_type' => 'Accumulator', 'struct_name' => 'intermediate_result', 'signature_template' => '{digit}' }, 'query_params hash correct' );
}
