...
ALTER TABLE analysis_stats DROP COLUMN behaviour, DROP COLUMN input_capacity, DROP COLUMN output_capacity;
ALTER TABLE analysis_stats_monitor DROP COLUMN behaviour, DROP COLUMN input_capacity, DROP COLUMN output_capacity;
