...
ALTER TABLE dataflow_target ADD COLUMN dataflow_target_id  SERIAL PRIMARY KEY;

ALTER TABLE analysis_ctrl_rule ADD COLUMN analysis_ctrl_rule_id SERIAL PRIMARY KEY;
