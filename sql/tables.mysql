...
CREATE TABLE dataflow_rule (
    ...
    branch_code             INTEGER     NOT NULL DEFAULT 1,         -- to be renamed "channel"
...
CREATE TABLE dataflow_target (
    dataflow_target_id      INTEGER     NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE analysis_ctrl_rule (
    analysis_ctrl_rule_id   INTEGER     NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE job (
    ...
    status                  ENUM('SEMAPHORED','READY','CLAIMED','COMPILATION','PRE_CLEANUP','FETCH_INPUT','RUN','WRITE_OUTPUT','POST_HEALTHCHECK','POST_CLEANUP','DONE','FAILED','PASSED_ON') DEFAULT 'READY' NOT NULL,
...
CREATE TABLE log_message (
    ...
    msg                     MEDIUMTEXT,
    message_class           ENUM('INFO', 'PIPELINE_CAUTION', 'PIPELINE_ERROR', 'WORKER_CAUTION', 'WORKER_ERROR') NOT NULL DEFAULT 'INFO',
