...
ALTER TABLE analysis_base ALTER COLUMN max_retry_count SET DATA TYPE INTEGER,
                          ALTER COLUMN max_retry_count DROP NOT NULL,
			  ALTER COLUMN max_retry_count DROP DEFAULT;
