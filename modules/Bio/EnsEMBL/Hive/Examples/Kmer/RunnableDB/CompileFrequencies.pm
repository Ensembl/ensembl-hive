...
=head1 SYNOPSIS
    ...
    Please refer to Bio::EnsEMBL::Hive::Examples::Kmer::PipeConfig::KmerPipeline_conf pipeline configuration file
...
package Bio::EnsEMBL::Hive::Examples::Kmer::RunnableDB::CompileFrequencies;
