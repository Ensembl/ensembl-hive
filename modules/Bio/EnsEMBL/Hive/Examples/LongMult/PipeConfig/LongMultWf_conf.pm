...
=head1 SYNOPSIS
    ...
    init_pipeline.pl Bio::EnsEMBL::Hive::Examples::LongMult::PipeConfig::LongMultWf_conf -password <mypass>
...
package Bio::EnsEMBL::Hive::Examples::LongMult::PipeConfig::LongMultWf_conf;
