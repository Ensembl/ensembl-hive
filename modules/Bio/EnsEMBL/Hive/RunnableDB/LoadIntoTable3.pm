...
Bio::EnsEMBL::Hive::RunnableDB::LoadIntoTable3

=head1 SYNOPSIS

    standaloneJob.pl Bio::EnsEMBL::Hive::RunnableDB::LoadIntoTable3 --table meta_foo \
...
package Bio::EnsEMBL::Hive::RunnableDB::LoadIntoTable3;
...
sub run {
    ...
    my $input_rows = $select_sth->fetchall_arrayref();
    my $select_n   = scalar(@$input_rows);
    ...
    my $select_sub = sub { shift @$input_rows };
    my $insert_n   = $insert_sth->execute_array( { ArrayTupleFetch => $select_sub } );
